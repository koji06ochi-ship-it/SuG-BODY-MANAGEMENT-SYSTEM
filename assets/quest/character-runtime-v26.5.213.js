(()=>{
  ...
  const css=`
  .v213Characters{margin:12px 0;border:1px solid #80642d;border-radius:18px;background:linear-gradient(145deg,#1d160c,#090806);padding:12px;position:relative;z-index:8}
  .v213Characters h3{margin:0;color:#ffe4a1;font-size:13px}.v213Characters p{margin:4px 0 10px;color:#a99a82;font:600 8px/1.5 -apple-system}
  .v213Strip{display:flex;gap:9px;overflow:auto;padding-bottom:4px}.v213Char{min-width:92px;border:1px solid #4b3a22;border-radius:13px;background:#11100c;padding:7px;color:#ddd;text-align:left}
  ...
  async function mount(doc){
    ...
    try{
      ...
      doc.documentElement.dataset.questCharacters='ready';
      return true;
    }catch(e){console.error('V214 characters',e);return false}
  }
