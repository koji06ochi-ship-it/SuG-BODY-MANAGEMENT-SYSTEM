...
function loadGuided(){if(loaded)return;loaded=true;document.getElementById('sugIdealFirst')?.remove();const s=document.createElement('script');s.src='./'+NEXT+'?v=26.5.250';(document.body||document.documentElement).appendChild(s)}
...
window.__SUG_IDEAL_FIRST_VERSION__='26.5.250';
})();