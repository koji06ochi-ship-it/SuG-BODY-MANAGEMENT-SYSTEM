const SW_VERSION = 'sug-v26.5.77-folder-nav';
...
self.addEventListener('fetch', event => {
 ...
 if(req.mode==='navigate'){
  event.respondWith((async()=>{try{const res=await fetch(req,{cache:'no-store'});const type=res.headers.get('content-type')||'';if(!type.includes('text/html'))return res;let html=await res.text();const tags=[
   '<script src="assets/member-home/v26.5.41/engine.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.42/login-render.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.44/onboarding.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.45/food-flow.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.49/force-food-home.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.51/meal-ai-client.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.51/food-photo.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.56/movement-ai.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.57/craving-check.js?v=26.5.77"></script>',
   '<script src="assets/member-home/v26.5.59/trainer-clinical-guard.js?v=26.5.77"></script>',
   ...
   '<script src="assets/trainer-ai/v26.5.77/haruto-yuyu-roles.js?v=26.5.77"></script>',
   '<script src="assets/ui/v26.5.77/folder-nav.js?v=26.5.77"></script>',
