...
final class MemberWebViewStore: ObservableObject {
    ...
    func installBodyRuntimeIfNeeded() {
        ...
        (function(){
          ...
          if (!isStandalone) {
            const scripts = [['sugIdealV27Script','assets/member/v27/ideal-v27.js?v=27.36'],['sugHealthV2Script','assets/member/v2/health-v2.js?v=27.36']];
    ...
    func installWalkRuntimeIfNeeded() {
        ...
        let js = """
        (function(){
          if (window.__SUG_WALK_NATIVE_V2736__) return;
          window.__SUG_WALK_NATIVE_V2736__ = true;
